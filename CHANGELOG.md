...
## [2.2.0](https://github.com/musikfestwochen/stage-safety-gateway/compare/v2.1.1...v2.2.0) - 2026-08-07

### Added

- add gateway health logging

### Fixed

- simplify health counter updates

## [2.1.1](https://github.com/musikfestwochen/stage-safety-gateway/compare/v2.1.0...v2.1.1) - 2026-07-29

### Fixed

- preserve gust peak timestamp

## [2.1.0](https://github.com/musikfestwochen/stage-safety-gateway/compare/v2.0.0...v2.1.0) - 2026-07-29

### Added

- add persistent gateway service

### Fixed

- avoid creating lock during status checks

## [2.0.0](https://github.com/musikfestwochen/stage-safety-gateway/compare/v1.0.2...v2.0.0) - 2026-07-27

### Added

- add minimum wind change threshold

## [1.0.2](https://github.com/musikfestwochen/stage-safety-gateway/compare/v1.0.1...v1.0.2) - 2026-07-27

### Fixed

- only trigger gust changes upward

## [1.0.1](https://github.com/musikfestwochen/stage-safety-gateway/compare/v1.0.0...v1.0.1) - 2026-07-25

### Fixed

- correct default ingestion URL

### Other

- refresh README branding
